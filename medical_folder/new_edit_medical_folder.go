...
func UpdateMedicalAntecedent(patientID string, antecedentID string, input model.UpdateMedicalAntecedentsInput) UpdateMedicalAntecedentResponse {
	patient, err := graphql.GetPatientById(patientID)
	if err != nil {
	...
	updatedAntecedent, err := graphql.UpdateMedicalAntecedents(antecedentID, input)
	if err != nil {
