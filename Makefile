...
test:
	@bold=$$(tput bold); \
	normal=$$(tput sgr0); \
	output=$$(go test -coverprofile=coverage.out -v ./appointment ./auth ./dashboard ./follow_treatment ./chat ./black_list ./medicament ./redis ./slot ./treatment ./double_auth ./ordonnance ./medical_folder| tee /dev/tty); \
