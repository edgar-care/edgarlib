...
//func AddParticipantToChat(patientID string, chatID string) UpdateChatResponse {
//	gqlClient := graphql.CreateClient()
//
//	_, err := graphql.GetPatientById(context.Background(), gqlClient, patientID)
//	if err != nil {
...
//	}
//
//	chat, err := graphql.GetChatById(context.Background(), gqlClient, chatID)
//	if err != nil {
//		return UpdateChatResponse{Chat: model.Chat{}, Code: 400, Err: errors.New("id does not correspond to a chat")}
//	}
//
//	for _, participant := range chat.GetChatById.Participants {
//		if participant.Participant_id == patientID {
//			return UpdateChatResponse{
//				Chat: model.Chat{
//					ID:           chat.GetChatById.Id,
//					Participants: chat.GetChatById.Participants,
//					Messages:     chat.GetChatById.Messages,
//				},
//				Code: 200,
//				Err:  nil,
//			}
...
//	}
//
//	participants := append(chat.GetChatById.Participants, graphql.ChatParticipantsInput{
//		Participant_id: patientID,
//		Last_seen:      int(time.Now().Unix()),
//	})
//
//	updatedChat, err := graphql.UpdateChat(context.Background(), gqlClient, chat.GetChatById.Id, participants, chat.GetChatById.Messages)
//	if err != nil {
//		return UpdateChatResponse{Chat: model.Chat{}, Code: 400, Err: errors.New("update failed: " + err.Error())}
//	}
//
